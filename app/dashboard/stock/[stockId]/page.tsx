...
import { Package, ShoppingCart, BarChart3, Users, Truck, TrendingUp, ArrowRightLeft } from "lucide-react"
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        {/* Réceptions card - only for libraries (not depot) */}
        {stockId !== 'gros' && (
          <Card className="hover:shadow-md transition-shadow cursor-pointer" onClick={() => navigateTo('received-movements')}>
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
